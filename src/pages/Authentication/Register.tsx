                ...
                <div className="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
                    <div className="!px-10 !py-12 card-body">
                        ...
                        <form action="/" className="mt-10" id="registerForm"
                            ...
                            <div className="mb-3">
                                <label htmlFor="phone-field" className="inline-block mb-2 text-base font-medium">Phone</label>
                                <input
                                    type="tel" 
                                    id="phone-field"
                                    name="phone" 
                                ...
                                {validation.touched.phone && validation.errors.phone ? (
                                    <div id="phone-error" className="mt-1 text-sm text-red-500">{validation.errors.phone}</div>
                                ) : null}
                            </div>
